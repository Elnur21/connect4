...
from connect4_ai import Alpha_Beta 
import time
...
class Connect4:
    ...
    def ai_turn(self, ai_level):
        ...
        Thread(target = ai.alpha_beta_decision, args=(self.board, self.turn, ai_level, self.ai_move, self.current_player(),)).start()
...
canvas_top = tk.Canvas (window, bg="white" , width=width , height =100)
